    ...
    <SidebarContainer position="left" {...props} ref={ref}>
      ...
      <Nav>
        <MainSidebarItem
          ...
          icon={<ShopMarkerIcon />}
          isActive={pathname === '/'}
          label={<FormattedMessage defaultMessage="Menu 1" />}
        />
        {/* <MainSidebarItem
          icon={<ShopMarkerIcon />}
